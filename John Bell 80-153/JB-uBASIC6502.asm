; =============================================================================
; JB-uBASIC6502 v1.1  --  2 KB Tiny BASIC (NMOS 6502)
;
; Derived from uBASIC6502 v1.4, refactored for NMOS 6502 mnemonics and
...
STR_BANNER: .DB "JB uBASIC v1.1"  ; startup banner, rolls into free
