 ...
 *
 * Listing output:
 *   By default, standalone assembly writes a sidecar .LST file next to the
 *   source file, replacing the source filename extension with .LST or
 *   appending .LST when there is no extension.  Use -NoList to suppress it.
 *
 * Output (normal mode):
...
static void asm_usage(FILE *out) {
    fprintf(out,
        ...
        "\n"
        "Listing files:\n"
        "  A .LST file is generated by default, replacing the final source filename\n"
        "  extension with .LST or appending .LST when the source has no extension.\n"
        "  Use -NoList to suppress list-file generation.\n"
        "\n"
